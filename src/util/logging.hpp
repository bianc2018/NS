...
#define LOG_DBG ns::util::log::logger(ns::util::log::LOGGER_DEBUG_STR)<<"["<<__FUNCTION__<<"]"
#define LOG_INFO ns::util::log::logger(ns::util::log::LOGGER_INFO_STR)<<"["<<__FUNCTION__<<"]"
#define LOG_WARN ns::util::log::logger(ns::util::log::LOGGER_WARN_STR)<<"["<<__FUNCTION__<<"]"
#define LOG_ERR ns::util::log::logger(ns::util::log::LOGGER_ERR_STR)<<"["<<__FUNCTION__<<"]"
#define LOG_FILE ns::util::log::logger(ns::util::log::LOGGER_FILE_STR, true)<<"["<<__FUNCTION__<<"]"
